          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="relative flex flex-col gap-1">
                <Utensils className="text-white/80 mb-1" size={22} strokeWidth={1.5} />
                <p className="font-display text-white text-sm leading-tight">{t.gastro.fastfood_name}</p>
              </div>
            </Link>
            <Link
              href="/gelato"
            ...
            >
              ...
              <div className="absolute inset-0 bg-white/0 hover:bg-white/10 transition-colors duration-200" />
              <div className="relative flex flex-col gap-1">
                <IceCreamCone className="text-white/80 mb-1" size={22} strokeWidth={1.5} />
                <p className="font-display text-white text-sm leading-tight">{t.gastro.gelato_name}</p>
              </div>
            </Link>
          </div>
          <a
